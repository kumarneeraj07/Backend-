...
import { uploadOnCloudnairy } from "../utlis/coludinary.js";
...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const coverImage = await uploadOnCloudnairy(coverImageLoacalPath);
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  if (!isPasswordValid) {
    throw new Apierror(401, "Invlid user credentails.");
  }
